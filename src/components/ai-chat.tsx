          ...
          <div className="space-y-4">
            <div className="flex flex-col gap-2 text-neutral-500 text-center">
              ...
              <span className="text-sm">
                Hello, I am your AI agent. I can help you with your prompts.
              </span>
            </div>
            {messages.map((message, index) => (
              <div
                key={index}
                className={`flex gap-3 p-4 rounded-lg ${message.role === "user"
                    ? "justify-end bg-primary/10"
                    : "justify-start bg-secondary/10"
                  }`}
              >
