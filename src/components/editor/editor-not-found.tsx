...
export default function EditorNotFound() {
    return (
        <section className="relative flex flex-col items-center justify-center gap-4 w-[calc(100vw-320px-288px-48px)] h-[calc(100vh-37px)] p-2 text-center border-l border-l-transparent dark:bg-neutral-900 dark:text-neutral-200 dark:border-neutral-800">
