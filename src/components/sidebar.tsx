...
function NoteItem({ id, content, createdAt }: NoteItemProps) {
    return (
        <li className="flex flex-col gap-2 py-2 px-4 border border-neutral-200 rounded-md">
        ...
        <section className="flex flex-col gap-2 min-w-80 w-80 h-screen p-2 border-l border-l-neutral-200">
            <Tabs defaultValue="versions" className="w-full">
                ...
                <TabsContent value="versions">
                    <Button variant="outline" className="w-full"><HistoryIcon /> New Version</Button>
                    <ScrollArea className="h-[calc(100vh-120px)]">
                        <ul className="flex flex-col gap-2 mt-4">
                            <li className="flex justify-between items-center gap-2 py-2 px-4 border border-neutral-200 rounded-md">
                ...
                <TabsContent value="notes">
                    <Button variant="outline" className="w-full"><NotebookPenIcon /> New Note</Button>
                    <ScrollArea className="h-[calc(100vh-120px)]">
                        <ul className="flex flex-col gap-2 mt-4">
